...
function btnChange(index,flag,speed){
	...
	var box4=document.getElementsByClassName("box04_content")[0];
	var box3=document.getElementsByClassName("box03_content")[0];
    ...
    if(flag){
        ...
        if(index <= 0 ){
			...
			nav_ul[index].className="nav_li_on";
...
box1.style.transform='scale(1.6)';
box1.style.transition='transform 0.8s';
setTimeout(function(){
